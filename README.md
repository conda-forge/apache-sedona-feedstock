...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/apache-sedona-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13812&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/apache-sedona-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `apache-sedona` can be installed with:

```
conda install apache-sedona
```

It is possible to list all of the versions of `apache-sedona` available on your platform with:
